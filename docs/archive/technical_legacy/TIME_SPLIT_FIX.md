...
原始配置文件 `src/full_531_basins/configs/camels_us/full_training/full_training_531_temporal_with_static.yml`（早期版本）中存在严重的时间分割问题：
...
- `src/full_531_basins/configs/camels_us/full_training/full_training_531_temporal_with_static.yml` - 主配置文件
