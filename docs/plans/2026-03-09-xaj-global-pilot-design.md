...
> Archived note: this document belongs to the earlier Caravan-oriented `xaj_global_pilot` phase. The active Idea 10 benchmark design now lives in `docs/plans/2026-03-27-global-conceptual-model-benchmark-impl.md` and follows a `CAMELS-US` first benchmark path.
