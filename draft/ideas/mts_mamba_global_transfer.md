...
| Task Results | `runs/`, `results/` | `results/mts_mamba_global_transfer/` | 本任务输出统一落盘 |
| Task Logs | `logs/` | `logs/mts_mamba_global_transfer/` | 本任务日志单独归档 |
...
| :--- | :--- | :--- | :--- |
| 41_caravan_daily_smoke_10basins_ep3_2026_0218_1802_ep3 | 2026-02-18 | `results/mts_mamba_global_transfer/41_caravan_daily_smoke_10basins_ep3_2026_0218_1802_ep3/` | 本地 CPU smoke 完成（10 basins, 3 epochs）: NSE=0.57383, KGE=0.52536 |
| 41_caravan_daily_smoke_2basins_ep1_2026_0218_1256_ep1 | 2026-02-18 | `results/mts_mamba_global_transfer/41_caravan_daily_smoke_2basins_ep1_2026_0218_1256_ep1/` | 本地 CPU smoke 训练完成（2 basins, 1 epoch） |
| caravan_global_hpc_v1 | 2026-01-06 | `results/mts_mamba_global_transfer/` | 本任务独立结果目录（待写入） |
...
| 2026-01-06 | 对话产物归档 | 将 HPC 相关代码、配置、文档映射到 `src/mts_mamba_global_transfer/`、`results/mts_mamba_global_transfer/`、`logs/mts_mamba_global_transfer/` |
...
- `results/mts_mamba_global_transfer/41_caravan_daily_smoke_2basins_ep1_2026_0219_1716_ep1/`
- 本地 smoke 验证指标（2026-02-19）：`NSE=0.44622`, `KGE=0.50352`
- `logs/mts_mamba_global_transfer/`（HPC 作业日志目录，仍可用于后续集群运行）

### 文档资产

- 本任务主文档：`draft/ideas/mts_mamba_global_transfer.md`
...
要求：仅使用 src/mts_mamba_global_transfer、results/mts_mamba_global_transfer、logs/mts_mamba_global_transfer 作为任务路径。
```
