...
![图2 库尾站小时级洪水预报研究技术路线](../../results/04_namou_kuwei/L9_kuwei_schematic_histflow_vs_rainonly.png)
...
![图3(a) 仅降雨输入条件下各模型在不同预见期下的NSE变化](../../results/04_namou_kuwei/L8_rainonly_nonmamba_nse_vs_leadtime.png)
...
![图3(b) 引入历史流量后各模型在不同预见期下的NSE变化](../../results/04_namou_kuwei/L7_fair_nse_vs_leadtime.png)

*图3(b) 引入历史流量后各模型在不同预见期下的NSE变化*

![图4 引入历史流量前后各模型NSE提升幅度比较](../../results/04_namou_kuwei/L9_fair_histflow_vs_rainonly_NSE_by_lead_model.png)
...
![图5 典型洪水过程下不同模型预报结果对比](../../results/04_namou_kuwei/L7_typical_flood_hydrograph_LT1h.png)
