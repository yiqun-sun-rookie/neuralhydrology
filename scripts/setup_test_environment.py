...
def create_test_data():
    ...
    try:
        result = subprocess.run([
            sys.executable, "scripts/create_test_data.py"
...
def run_quick_test():
    ...
    config_file = "configs/test_data/quick_test.yml"
...
def main():
    ...
    print("2. 运行完整测试: python simple_train.py --config configs/test_data/test_config.yml")
