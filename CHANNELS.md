...
| `attrswap-daily` | 日尺度线中国线三个实验共用通道：①中国可供属性替换（PREREG_20260901，7 臂，seq 1–10）②气象口径替换（PREREG_20260908，9 臂，seq 11–29）③美国侧全球降水产品对比第一段（PREREG_20260909，6 臂，seq 30–49）：只读探测、隔离部署、训练、取回；三个实验 2026-09-10 全部封板 | 2026-09-05（2026-09-11 补登②③） | 三个独立落点 `/data1/home/sunyiq/attr_swap_daily_2026_09`、`forcing_swap_daily_2026_09`、`precip_swap_daily_2026_09`（影子数据三级符号链接 precip→forcing→attr→`~/neuralhydrology/data/camels_us`；归档代码 `git archive 1f9804e` 在 attr 落点）；不碰 `~/neuralhydrology` 的 git 状态、其他通道、其他实验或既有证据；作业日志写落点不写信箱；禁止 `scancel -u`，只按本通道 job ID 取消；封板后只发只读探测 |
