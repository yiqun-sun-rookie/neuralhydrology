...
| `kalmannet-wrr-lr-boundary` | 《水资源研究》论文学习率上边界核查：本地学习率0.03继续运行，超算仅并行学习率0.05及其必要核验 | 2026-09-01 | 独立落点 `/data1/home/sunyiq/kalmannet_wrr_lr_boundary_20260901`；不提前运行条件学习率0.1，不读取保留测试集，不碰 `~/neuralhydrology`、其他通道、作业、实验或既有证据 |
