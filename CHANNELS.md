...
| `attrswap-daily` | 日尺度线中国可供属性替换实验（预注册 PREREG_20260901；7 臂：口径校准 ref27-parity s900 + armA chn23 s100/200/300 + armB drop23 s100/200/300）：只读探测、隔离部署、训练、取回 | 2026-09-05 | 独立落点 `/data1/home/sunyiq/attr_swap_daily_2026_09`；只读引用 `~/neuralhydrology/data/camels_us`（符号链接）与 `git archive 1f9804e`；不碰 `~/neuralhydrology` 的 git 状态、其他通道、其他实验或既有证据；作业日志写落点不写信箱；禁止 `scancel -u`，只按本通道 job ID 取消 |
