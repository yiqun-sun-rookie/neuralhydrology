...
| `attrswap-daily` | 日尺度线中国线三个实验共用通道：①中国可供属性替换（PREREG_20260901，7 臂，seq 1–10）②气象口径替换（PREREG_20260908，9 臂，seq 11–29）③美国侧全球降水产品对比第一段（PREREG_20260909，6 臂，seq 30–49）④**第二段·近代合同**（PREREG_20260911，8 参照 + 24 候选 = 32 臂，seq 51 起，用户 2026-09-11「approve 4 all」授权）：只读探测、隔离部署、训练、取回；①②③ 2026-09-10 封板 | 2026-09-05（2026-09-11 补登②③④） | 四个独立落点 `/data1/home/sunyiq/attr_swap_daily_2026_09`、`forcing_swap_daily_2026_09`、`precip_swap_daily_2026_09`（三者封板只读）、**`precip_swap2_daily_2026_09`（④，可写）**；影子数据符号链接（precip2 的 daymet 直连 `~/neuralhydrology/data/camels_us/basin_mean_forcing/daymet`，流量/属性经 attr 落点）；归档代码 `git archive 1f9804e` 在 attr 落点（precip2 有副本）；不碰 `~/neuralhydrology` 的 git 状态、其他通道、其他实验或既有证据；作业日志写落点不写信箱；禁止 `scancel -u`，只按本通道 job ID 取消；①②③ 只发只读探测 |
