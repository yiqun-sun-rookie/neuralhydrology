"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2r14 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2r14"
ARCHIVE_NAME = "tukf09_455_basin_zero_validation_target_variance_revision_v1_hpc_execution_a800_exclusive_v2r14_formal_training.tar.gz"
INTERNAL_MANIFEST_NAME = "bundle_manifest.json"
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2r14"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2r14"
...
LOCAL_FILTER_INSTALLATION_FINAL_SHA256 = (
    "ec222536b144e256e152cdaa857440d4482abac74c4eaf7ca6ab9dd8340bb79c"
)
...
CONFIG_RELATIVES = (
    ...
    "configs/tukf09_455_basin_zero_validation_target_variance_hpc_execution_a800_exclusive_v2r14.json",
    "configs/tukf09_455_basin_zero_validation_target_variance_revision_v1.json",
)
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r14/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r14/download_runtime_inputs_login.sh",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r14/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r14/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r14/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r14/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r14/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r14/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2r14.py"
...
def _validate_config_anchors(
    ...
    *,
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2r14"
        or hpc.get("experiment_id") != EXPERIMENT_ID
        or hpc.get("execution_route", {}).get("formal_evaluation_access") is not False
        or hpc.get("execution_route", {}).get("neural_model_parallelism") != 4
        ...
        != {
            "revision": "v2r14",
            "supersedes_revision": "v2r13",
            "v2r12_was_deployed_but_never_ran_a_training_job": True,
            "v2r12_preparation_job_id": 223992,
            "v2r12_preparation_job_state": "CANCELLED_BY_OPERATOR_WHILE_PENDING",
            "reason_for_this_version": "the_eight_card_partition_could_not_schedule_the_job_for_six_days_while_a_four_card_node_was_free_immediately",
            "hgpu8_node_reserved_by_another_group_until": "2027-09-06",
            "hgpu8_remaining_nodes_fully_allocated": True,
            "hgpu8_scheduler_start_estimate": "2026-09-15T08:33:19",
            "partition_before": "hgpu8",
            "partition_after": "hgpu4",
            "card_before": "NVIDIA A800-SXM4-80GB",
            "card_after": "NVIDIA A40",
            "card_change_is_technical_not_scientific": True,
            "no_admitted_executable_pins_the_card_model": True,
            "bitwise_equivalence_across_card_models_claimed": False,
            "all_nine_models_run_on_the_same_card_model_so_they_stay_mutually_comparable": True,
            "neural_model_parallelism_before": 8,
            "neural_model_parallelism_after": 4,
            "waves_before": [1, 8],
            "waves_after": [1, 4, 4],
            "projected_hours_before": 30,
            "projected_hours_after": 45,
            "gpus": 4,
            "cpus_per_task": 16,
            "node_total_cpus": 96,
            "cpus_returned_to_other_users": 80,
            "exclusive_node_directive_removed": True,
            "all_gres_held_so_no_other_gpu_job_can_be_scheduled_on_this_node": True,
            "whole_node_compute_process_gate_weakened": False,
            "probe_job_id": 224326,
            "probe_showed_zero_foreign_compute_processes": True,
            "all_scope_authorization_re_registered": True,
            "all_scope_authorization_text": "全部授权",
            "filter_migration_re_derived_so_identities_carry_the_current_authorization": True,
            ...
            "population_defect_fix_carried_forward": True,
            ...
            "version_directory_name_still_says_a800_exclusive_for_historical_continuity": True,
            ...
            "v2r13_preparation_job_id": 224439,
            "v2r13_preparation_job_state": "FAILED",
            "v2r13_preparation_node": "ngu104",
            "v2r13_preparation_elapsed": "00:05:14",
            "v2r13_failure_line": "probe_gpu.slurm inline runtime import check, assert tuple(torch.cuda.get_device_capability(0)) == (8, 0)",
            "v2r13_failure_cause": "the_card_retarget_replaced_the_not_equal_and_set_spellings_of_the_capability_literal_but_missed_the_equality_spelling_inside_the_job_script",
            "v2r13_failure_is_a_wrapper_typo_not_a_contract_or_science_problem": True,
            "v2r13_root_frozen_and_kept_as_evidence": True,
            "a40_confirmed_working_before_the_failing_line": True,
            "a40_confirmed_private_runtime_imports_torch_2_2_2_cu121": True,
            "a40_confirmed_four_cards_visible_and_named": True,
            "scientific_identity_unchanged_from_v2r13": True,
            "no_re_admission_no_re_migration_no_new_capsule_needed": True,
            "capsule_v7_still_valid": True,
        }
        or source_capsule
        != {
            "schema_version": "tukf09_455_training_source_capsule_v2",
            "root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v7_20260909",
            "data_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v7_20260909/data/camels_us",
            "manifest": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v7_20260909/evidence/source_capsule_manifest.json",
            "manifest_size": 541722,
            "manifest_sha256": "40dbf1a840b195696d99dcde1cc1ba8cdc73ef8137078dfd6844d4b4c07e3c03",
            "manifest_sha256_record": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v7_20260909/evidence/source_capsule_manifest.sha256",
            "manifest_sha256_record_size": 95,
            "manifest_sha256_record_sha256": "56c280947f119cc1bc7da6fb1170cbe84c972c3d61302dd1c336bae51024982f",
            "ready": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v7_20260909/evidence/READY.json",
            "ready_size": 1217,
            "ready_sha256": "4bfbd17c0042d931e8c5d80a4e3e28ebee18de2d384eac0035224ddb95864015",
            "data_file_count": 911,
            ...
            "deployment_mailbox_sequence": 152,
            "deployment_command_sha256": "93afba664a4b0ff3e4bd034d8213721e70c0597d574729d49726b95a71d0bff2",
            "deployment_result_commit": "8909a0bcea6ebb52d8664f5b5ed37141d86804b0",
            "deployment_result_size": 5126,
            "deployment_result_sha256": "32ab6cacbc372f325a08066a764b6db84c399e120b5469ff5bfac746252a800b",
            "post_publication_audit_mailbox_sequence": 153,
            "post_publication_audit_command_size": 8971,
            "post_publication_audit_command_sha256": "6749ffafbcd0c9065821ce93382edd3e9af78a3e2fb72ffc6df849594a6cb6dd",
            "post_publication_audit_result_commit": "dd3280079500615c6c15a67ec93acc91c484b8af",
            "post_publication_audit_result_size": 911,
            "post_publication_audit_result_sha256": "1d2bfef7f4b6fc363e725a9a754db0b31cb6871995368404e38f5795e2fdde3b",
            "post_publication_audit_status": "PASS",
            "post_publication_audit_rehashed_files": 911,
            "post_publication_audit_rehash_failures": 0,
            "supersedes_capsule_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v6_20260908",
            "supersedes_reason": "the_eight_card_nodes_could_not_schedule_the_job_for_six_days_so_the_models_trained_at_once_moved_from_eight_to_four_which_re_issued_the_authorization_the_migration_and_the_admission",
        ...
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r14_20260909/status/PREPARATION_FAILED.json"
        or hpc_remote_layout.get("runtime_pending_glob")
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r14_20260909/runtime_v2r14.pending.*"
        ...
        != "preserve_the_partial_reserved_destination_and_freeze_the_v2r14_remote_root_no_same_root_retry"
        or hpc_data_staging.get("existing_tree_policy")
        != "exact_verify_only_no_overwrite"
        or offline_inputs.get("schema_version")
        != "tukf09_455_hpc_offline_runtime_inputs_a800_exclusive_v2r14"
        ...
        or hpc_runtime.get("cuda_device_count") != 4
        or hpc_runtime.get("cuda_device_name") != "NVIDIA A40"
        or hpc_runtime.get("cuda_compute_capability") != [8, 6]
        ...
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2r14"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R14_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R14_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2r14 bundle."
    )
