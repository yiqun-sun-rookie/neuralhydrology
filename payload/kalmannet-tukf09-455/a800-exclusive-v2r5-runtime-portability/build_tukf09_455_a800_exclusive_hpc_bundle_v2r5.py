"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2r5 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2r5"
...
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2r5"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2r5"
...
CONFIG_RELATIVES = (
    ...
    "configs/tukf09_455_basin_zero_validation_target_variance_hpc_execution_a800_exclusive_v2r5.json",
    "configs/tukf09_455_basin_zero_validation_target_variance_revision_v1.json",
)
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r5/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r5/download_runtime_inputs_login.sh",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r5/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r5/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r5/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r5/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r5/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r5/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2r5.py"
...
def _validate_config_anchors(
    ...
    *,
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2r5"
        ...
        != {
            "revision": "v2r5",
            "superseded_remote_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r4_20260901",
            "failed_training_submission_mailbox_sequence": 58,
            "failed_training_terminal_snapshot_mailbox_sequence": 59,
            "failed_training_forensics_mailbox_sequence": 60,
            "failed_training_job_id": 217409,
            "failed_training_job_state": "FAILED",
            "failed_training_exit_code": "1:0",
            "failed_training_stdout_size": 0,
            "failed_training_stdout_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
            "failed_training_stderr_size": 1668,
            "failed_training_stderr_sha256": "255f1041ddcdbaeeb0dd87ea2ff40c4b28462c3703e86baf59e18b7e74f4faf9",
            "failed_builder_sha256": "4ccb9026a4de33f71ae173ef7d64d4839e634529219da2c65cff8fcf045215fd",
            "failed_execution_config_sha256": "54bb8226621c440983d1a8f4d1291b9980488296bc9658085abef47efe56b3f6",
            "failure_boundary": "runtime_bundle_verification_before_neural_training_controller_start_and_before_first_model",
            "root_cause": "runtime_bundle_verifier_rechecks_local_filter_seal_at_remote_mutable_path",
            "local_filter_installation_final_sha256": "b378ffbfde4d24ded8fbb42fdf10fef59eb04100c93879a41b4d538ae36f6ba0",
            "remote_filter_installation_final_sha256": "6e150cd9feba58ec35562e7fc46e7052f9e433cc5a50ae185593f1960703a55f",
            "forensics_result_commit": "118564f5b64a4b4e6e21c8cfd32c0eb9b6bc2461",
            "forensics_result_size": 3569,
            "forensics_result_sha256": "127b641be4373d2fc5dcce8eccf6e48c23d6d63e2f5e79a498aa414e75d9bfa8",
            "neural_units_completed": 0,
            "repair": "skip_only_the_optional_local_filter_seal_recheck_during_extracted_runtime_verification_after_remote_independent_filter_installation_while_preserving_source_build_validation",
            "preserve_failed_remote_root": True,
            "retry_failed_v2r4_root_allowed": False,
        ...
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r5_20260901/status/PREPARATION_FAILED.json"
        or hpc_remote_layout.get("runtime_pending_glob")
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r5_20260901/runtime_v2r5.pending.*"
        ...
        != "preserve_the_partial_reserved_destination_and_freeze_the_v2r5_remote_root_no_same_root_retry"
        or hpc_data_staging.get("existing_tree_policy")
        != "exact_verify_only_no_overwrite"
        or offline_inputs.get("schema_version")
        != "tukf09_455_hpc_offline_runtime_inputs_a800_exclusive_v2r5"
        ...
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2r5"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R5_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R5_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2r5 bundle."
    )
