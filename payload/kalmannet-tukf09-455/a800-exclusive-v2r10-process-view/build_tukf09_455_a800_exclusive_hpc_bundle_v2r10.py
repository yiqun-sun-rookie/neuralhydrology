"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2r10 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2r10"
ARCHIVE_NAME = "tukf09_455_basin_zero_validation_target_variance_revision_v1_hpc_execution_a800_exclusive_v2r10_formal_training.tar.gz"
INTERNAL_MANIFEST_NAME = "bundle_manifest.json"
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2r10"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2r10"
...
LOCAL_FILTER_INSTALLATION_FINAL_SHA256 = (
    "a8406916d412f366e1c82b7407f138844cd90fe1c2384f9f78f24dc5210967a7"
)
...
CONFIG_RELATIVES = (
    ...
    "configs/tukf09_455_basin_zero_validation_target_variance_hpc_execution_a800_exclusive_v2r10.json",
    "configs/tukf09_455_basin_zero_validation_target_variance_revision_v1.json",
)
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r10/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r10/download_runtime_inputs_login.sh",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r10/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r10/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r10/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r10/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r10/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r10/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2r10.py"
...
def _validate_config_anchors(
    ...
    *,
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2r10"
        or hpc.get("experiment_id") != EXPERIMENT_ID
        or hpc.get("execution_route", {}).get("formal_evaluation_access") is not False
        or hpc.get("execution_route", {}).get("neural_model_parallelism") != 1
        ...
        != {
            "revision": "v2r10",
            "superseded_remote_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r9_20260904",
            "superseded_training_job_id": 220503,
            "superseded_training_job_state": "FAILED",
            "superseded_training_exit_code": "1:0",
            "superseded_training_node": "ngu203",
            "superseded_training_elapsed": "00:02:25",
            "failure_boundary": "inside_the_new_process_tree_walk_before_the_gate_reached_a_verdict",
            "probe_parser_repair_confirmed_effective": True,
            "process_tree_gate_intent_confirmed_correct": True,
            "root_cause": "the_first_ancestor_walk_constructed_a_process_object_for_the_process_table_root_which_the_job_container_hides_and_the_library_raised_a_plain_operating_system_error_the_walk_did_not_catch",
            "root_cause_introduced_by": "this_repair_line_not_the_frozen_experiment",
            "repair": "read_the_ancestor_identifier_without_constructing_anything_for_the_process_table_root_take_the_immediate_parent_from_the_operating_system_and_tolerate_both_error_families",
            "superseded_controller_sha256": "aafb099fbdd4f84e6ab4ee6f066ad19e80e35ed73c47e7783edb12183d8b0bed",
            "repaired_controller_sha256": "b50af402b7631234fe32adea2e3cabd431394e396dafcdbac471fcb7e2f67c4e",
            "superseded_training_admission_record_sha256": "3b0f824da60b59ddfef316e38573f176a4e28d07d62d46995b24e1832a5eef88",
            "current_training_admission_record_sha256": "d81cde63b9936ede157bcc6e3020f9a0deb67ea88f89ae701810fa8bbf2e6fb3",
            "superseded_local_filter_installation_final_sha256": "872820b08c11afaddfd85fa5412169fd495f39c1f37591e07966cc7767e68cc4",
            "current_local_filter_installation_final_sha256": "a8406916d412f366e1c82b7407f138844cd90fe1c2384f9f78f24dc5210967a7",
            "superseded_capsule_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v4_20260904",
            "new_capsule_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v5_20260904",
            "new_capsule_data_identity_sha256": "dd238eebc1696f73f9eee7adf924913ff5a912c8f795f8998255e87408b760da",
            "new_capsule_data_identity_equals_superseded": True,
            "new_capsule_publication_mailbox_sequence": 125,
            "new_capsule_audit_mailbox_sequence": 126,
            "new_capsule_audit_status": "PASS",
            "frozen_test_suite_passed_count": 309,
            "excluded_nodes": [],
            "exclusive_whole_node_requirement_relaxed": False,
            "whole_node_compute_process_gate_weakened": False,
            "whole_node_compute_process_gate_still_hard_stops_outside_the_run": True,
            "neural_units_completed": 0,
            "preserve_superseded_remote_roots": True,
            "preserve_superseded_capsules": True,
            "retry_v2r8_root_allowed": False,
            "retry_v2r9_root_allowed": False,
        ...
        != {
            ...
            "root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v5_20260904",
            "data_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v5_20260904/data/camels_us",
            "manifest": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v5_20260904/evidence/source_capsule_manifest.json",
            "manifest_size": 541659,
            "manifest_sha256": "a61b52ad609598d083b87ea869c6674d10f70e88ea15db80da52609bd3d913f6",
            "manifest_sha256_record": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v5_20260904/evidence/source_capsule_manifest.sha256",
            "manifest_sha256_record_size": 95,
            "manifest_sha256_record_sha256": "abc39451994261d2760261562ed430b247ba6023e7e9ce68305128547fdb720f",
            "ready": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v5_20260904/evidence/READY.json",
            "ready_size": 1217,
            "ready_sha256": "0cc1635707e6651c8f5a942e47dcd8453d11280b66fd2d061638ac3c865eef50",
            "data_file_count": 911,
            ...
            "deployment_mailbox_sequence": 125,
            "deployment_command_sha256": "b4f756238a8ec732b4c7138e6781ada21fcb542382cf2d5dcf4af7a6e3540f33",
            "deployment_result_commit": "d6fb1a0c8d20d6cc88e1acd05f255fb2fc875dbc",
            "deployment_result_size": 2328,
            "deployment_result_sha256": "279eef22edf8b273f7f46827cfc48b55507424c779a8091ebb32abda1f842495",
            "failed_post_publication_audit_mailbox_sequence": 107,
            "failed_post_publication_audit_result_commit": "507f5091801568b266a53c206c7c24d0ef06898d",
            "failed_post_publication_audit_result_size": 2235,
            "failed_post_publication_audit_result_sha256": "030010eb764c865e224c279202038e48a530f7c982daf1aa8f8bedf2a6321fa8",
            "failed_post_publication_audit_root_cause": "the_auditor_required_all_911_files_in_the_raw_source_manifest_although_the_topography_file_is_pinned_separately",
            "post_publication_audit_mailbox_sequence": 126,
            "post_publication_audit_command_size": 8203,
            "post_publication_audit_command_sha256": "3c45f0d1bf237ab02453e89a5fefcbd00fe76bd60dbf7bec4584ad52218fead8",
            "post_publication_audit_result_commit": "4169f8abcdad01c248c507c70db1e3fcbc281001",
            "post_publication_audit_result_size": 2182,
            "post_publication_audit_result_sha256": "644da19f395ddde96875b6ae1c46544dc71d7c44c33a8e467c4e6cf67f94488e",
            "post_publication_audit_status": "PASS",
            "supersedes_capsule_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_training_source_capsule_v4_20260904",
            "supersedes_reason": "the_process_gate_ancestor_walk_repair_re_signed_the_training_admission_so_the_v4_capsule_identity_became_stale",
        ...
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r10_20260904/status/PREPARATION_FAILED.json"
        or hpc_remote_layout.get("runtime_pending_glob")
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r10_20260904/runtime_v2r10.pending.*"
        ...
        != "preserve_the_partial_reserved_destination_and_freeze_the_v2r10_remote_root_no_same_root_retry"
        or hpc_data_staging.get("existing_tree_policy")
        != "exact_verify_only_no_overwrite"
        or offline_inputs.get("schema_version")
        != "tukf09_455_hpc_offline_runtime_inputs_a800_exclusive_v2r10"
        ...
        or hpc_slurm.get("cpus_per_task") != 4
        or hpc_slurm.get("gpus") != 1
        or hpc_slurm.get("exclusive_node") is not True
        or hpc_slurm.get("excluded_nodes") != []
        or hpc_slurm.get("wall_time") != "18:00:00"
        ...
        or hpc_runtime.get("cuda_device_count") != 1
        ...
        != 80_000_000_000
        or hpc_runtime.get(
            "require_current_pytorch_process_gpu_uuid_to_equal_slurm_selected_gpu_uuid"
        )
        is not True
        or private_runtime.get("schema_version")
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2r10"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R10_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R10_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2r10 bundle."
    )
