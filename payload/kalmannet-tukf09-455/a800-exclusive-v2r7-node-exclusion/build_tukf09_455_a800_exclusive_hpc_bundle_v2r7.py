"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2r7 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2r7"
ARCHIVE_NAME = "tukf09_455_basin_zero_validation_target_variance_revision_v1_hpc_execution_a800_exclusive_v2r7_formal_training.tar.gz"
INTERNAL_MANIFEST_NAME = "bundle_manifest.json"
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2r7"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2r7"
...
CONFIG_RELATIVES = (
    ...
    "configs/tukf09_455_basin_zero_validation_target_variance_hpc_execution_a800_exclusive_v2r7.json",
    "configs/tukf09_455_basin_zero_validation_target_variance_revision_v1.json",
)
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r7/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r7/download_runtime_inputs_login.sh",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r7/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r7/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r7/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r7/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r7/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r7/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2r7.py"
...
def _validate_config_anchors(
    ...
    *,
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2r7"
        ...
        != {
            "revision": "v2r7",
            "superseded_remote_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r6_20260902",
            "superseded_preparation_job_id": 218635,
            "superseded_preparation_job_state_when_superseded": "PENDING",
            "superseded_preparation_job_ever_started": False,
            "superseded_preparation_queue_reason": "Resources",
            "superseded_preparation_estimated_start": "2026-09-12T18:55:10",
            "superseded_preparation_cancelled": True,
            "failure_boundary": "none_the_superseded_preparation_job_never_started",
            "root_cause": "an_inherited_node_exclusion_kept_the_exclusive_request_off_the_only_idle_whole_node",
            "excluded_nodes_before": ["ngu203"],
            "excluded_nodes_after": [],
            "inherited_exclusion_carried_unreviewed_since_revision": "v2",
            "node_health_probe_job_id": 219417,
            "node_health_probe_node": "ngu203",
            "node_health_probe_state": "COMPLETED",
            "node_health_probe_exit_code": "0:0",
            "node_health_probe_gpu_count": 8,
            "node_health_probe_gpu_name": "NVIDIA A800-SXM4-80GB",
            "node_health_probe_driver_version": "535.104.05",
            "node_health_probe_exclusive_cpus_on_node": 64,
            "node_health_probe_max_absolute_error_against_double_cpu": 0.0005367804357661043,
            "node_health_probe_verdict": "HEALTHY",
            "node_health_probe_pmon_stdout_sha256": "16c2b7b18ee3f2ed87c2f2ce8eeed5fecd0f25050c4bea50eac5648e5093de25",
            "probe_table_format_byte_identical_to_the_other_partition_node": True,
            "repaired_controller_sha256": "4bdb4527e2f89c2765a71472411890535896cf1f405bf8cd7cf5c89ea5709ecd",
            "training_admission_record_sha256": "01f221fd516ce9d48675f371619542735270134b3bfc7e8fde04a6c6f0747df5",
            "local_filter_installation_final_sha256": "a5ac72e63cf9c18710b008d1643ed8926dbb6ff729dacb8757b78ff65948101b",
            "neural_units_completed": 0,
            "repair": "drop_only_the_inherited_node_exclusion_after_an_exclusive_gpu_health_probe_confirmed_that_node",
        ...
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r7_20260904/status/PREPARATION_FAILED.json"
        or hpc_remote_layout.get("runtime_pending_glob")
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r7_20260904/runtime_v2r7.pending.*"
        ...
        != "preserve_the_partial_reserved_destination_and_freeze_the_v2r7_remote_root_no_same_root_retry"
        or hpc_data_staging.get("existing_tree_policy")
        != "exact_verify_only_no_overwrite"
        or offline_inputs.get("schema_version")
        != "tukf09_455_hpc_offline_runtime_inputs_a800_exclusive_v2r7"
        ...
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2r7"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R7_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R7_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2r7 bundle."
    )
