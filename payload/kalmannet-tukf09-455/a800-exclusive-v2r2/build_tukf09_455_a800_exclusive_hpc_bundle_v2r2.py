"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2r2 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2r2"
...
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2r2"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2r2"
...
CONFIG_RELATIVES = (
    ...
    "configs/tukf09_455_basin_zero_validation_target_variance_hpc_execution_a800_exclusive_v2r2.json",
    "configs/tukf09_455_basin_zero_validation_target_variance_revision_v1.json",
)
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r2/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r2/download_runtime_inputs_login.sh",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r2/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r2/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r2/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r2/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r2/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r2/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2r2.py"
...
def _validate_config_anchors(root: Path, admission: Mapping[str, Any]) -> None:
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2r2"
        ...
        != {
            "revision": "v2r2",
            "superseded_remote_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r1_20260901",
            "failed_preparation_job_id": 217163,
            "failed_preparation_state": "FAILED",
            "failed_preparation_exit_code": "2:0",
            "failed_preparation_stdout_sha256": "3e5abfb0698e75b0d9f5c28c3bd98102384ad02c4ddd8386624443a8a6e8ec93",
            "failed_preparation_stderr_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
            "failed_initial_bundle_verification_sha256": "e1439af9226a3e94d7b8951e4f471e8c678990e3fbeb366c2e919cf9a3eae6b7",
            "failed_pip_stdout_sha256": "f2b4b652eb10ebbf157a9d08a1871328059ced1aa941a8a7d41e14de9ce5be84",
            "failed_pip_stderr_sha256": "f9e8fe66ce1f3834235bba544f558c7cf0e45ac077dda75e119a97f0311dc71c",
            "failure_boundary": "after_runtime_bundle_verification_during_first_locked_pytorch_download_before_any_final_runtime_or_scientific_output",
            "root_cause": "compute_node_dns_resolution_failure_for_download_pytorch_org",
            "repair": "download_and_freeze_the_exact_locked_runtime_inputs_on_login4_then_copy_and_install_them_offline_inside_a_new_slurm_preparation_job",
            "preserve_failed_remote_root": True,
            "scientific_contract_changed": False,
            "formal_evaluation_authorized": False,
        }
        or offline_inputs.get("schema_version")
        != "tukf09_455_hpc_offline_runtime_inputs_a800_exclusive_v2r2"
        ...
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2r2"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R2_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R2_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2r2 bundle."
    )
