"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2r3 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2r3"
...
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2r3"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2r3"
...
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r3/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r3/download_runtime_inputs_login.sh",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r3/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r3/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r3/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r3/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r3/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r3/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2r3.py"
...
def _validate_config_anchors(root: Path, admission: Mapping[str, Any]) -> None:
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2r3"
        ...
        != {
            "revision": "v2r3",
            "superseded_remote_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r2_20260901",
            "failed_deployment_mailbox_sequence": 32,
            "failed_deployment_exit_code": 1,
            "failed_deployment_forensics_mailbox_sequence": 33,
            "failed_remote_root_size_bytes": 16384,
            "failed_remote_root_top_level_directory_count": 3,
            "failed_remote_root_file_count": 0,
            "failed_remote_root_slurm_job_count": 0,
            "failure_boundary": "after_creating_the_new_root_and_three_empty_directories_before_copying_the_first_payload_file",
            "root_cause": "cluster_coreutils_cp_rejects_the_reflink_never_argument",
            "repair": "copy_every_file_with_python_exclusive_creation_buffered_bytes_fsync_and_post_copy_size_sha256_verification",
            "preserve_failed_remote_root": True,
            "scientific_contract_changed": False,
            "formal_evaluation_authorized": False,
        }
        or offline_inputs.get("schema_version")
        != "tukf09_455_hpc_offline_runtime_inputs_a800_exclusive_v2r3"
        ...
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2r3"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R3_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R3_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2r3 bundle."
    )
