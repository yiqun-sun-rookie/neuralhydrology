"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2r4 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2r4"
...
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2r4"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2r4"
...
CONFIG_RELATIVES = (
    ...
    "configs/tukf09_455_basin_zero_validation_target_variance_hpc_execution_a800_exclusive_v2r4.json",
    "configs/tukf09_455_basin_zero_validation_target_variance_revision_v1.json",
)
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r4/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r4/download_runtime_inputs_login.sh",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r4/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r4/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r4/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r4/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r4/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r4/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2r4.py"
...
def _validate_config_anchors(root: Path, admission: Mapping[str, Any]) -> None:
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2r4"
        ...
        != {
            "revision": "v2r4",
            "superseded_remote_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r3_20260901",
            "failed_preparation_submission_mailbox_sequence": 38,
            "failed_preparation_result_mailbox_sequence": 39,
            "failed_preparation_forensics_mailbox_sequence": 40,
            "failed_preparation_job_id": 217185,
            "failed_preparation_job_state": "FAILED",
            "failed_preparation_exit_code": "1:0",
            "failure_boundary": "after_private_runtime_and_initial_bundle_verification_before_staged_source_manifest_preparation_probe_technical_admission_or_training",
            "root_cause": "three_maurer_training_validation_forcing_files_in_the_v2r3_shared_source_root_differed_in_size_and_sha256_from_the_frozen_raw_source_manifest",
            "failed_source_exact_file_count": 908,
            "failed_source_mismatch_count": 3,
            "failed_source_expected_file_count": 911,
            "failed_source_expected_total_bytes": 464792200,
            "failed_source_actual_total_bytes": 464792149,
            "failed_source_mismatch_identity_sha256": "352933512117b6fb2ef5f4f04a1958c795546ccddd3da9380e57cb1e149f6c64",
            "repair": "bind_v2r4_to_a_new_read_only_no_link_911_file_source_capsule_whose_exact_ready_manifest_and_data_identity_are_frozen_below",
            "preserve_failed_remote_root": True,
            "retry_failed_v2r3_root_allowed": False,
        ...
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r4_20260901/status/PREPARATION_FAILED.json"
        or hpc_remote_layout.get("runtime_pending_glob")
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r4_20260901/runtime_v2r4.pending.*"
        ...
        != "preserve_the_partial_reserved_destination_and_freeze_the_v2r4_remote_root_no_same_root_retry"
        or hpc_data_staging.get("existing_tree_policy")
        != "exact_verify_only_no_overwrite"
        or offline_inputs.get("schema_version")
        != "tukf09_455_hpc_offline_runtime_inputs_a800_exclusive_v2r4"
        ...
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2r4"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R4_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R4_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2r4 bundle."
    )
