"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2"
...
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2"
...
CONFIG_RELATIVES = (
    ...
    "configs/tukf09_455_basin_zero_validation_target_variance_hpc_execution_a800_exclusive_v2.json",
    "configs/tukf09_455_basin_zero_validation_target_variance_revision_v1.json",
)
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2.py"
...
def _validate_config_anchors(root: Path, admission: Mapping[str, Any]) -> None:
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2"
        ...
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2 bundle."
    )
