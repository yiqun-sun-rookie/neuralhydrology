"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2r1 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2r1"
...
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2r1"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2r1"
...
CONFIG_RELATIVES = (
    ...
    "configs/tukf09_455_basin_zero_validation_target_variance_hpc_execution_a800_exclusive_v2r1.json",
    "configs/tukf09_455_basin_zero_validation_target_variance_revision_v1.json",
)
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r1/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r1/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r1/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r1/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r1/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r1/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r1/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2r1.py"
...
def _validate_config_anchors(root: Path, admission: Mapping[str, Any]) -> None:
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2r1"
        ...
        != {
            "revision": "v2r1",
            "superseded_remote_root": "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2_20260831",
            "failed_preparation_job_id": 217149,
            "failed_preparation_state": "FAILED",
            "failed_preparation_exit_code": "13:0",
            "failed_preparation_stdout_sha256": "ca71574f0fecc9e6a5f16ac13883d1b4d269c6577b8bb1c1a35e3d03032ceb58",
            "failed_preparation_stderr_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
            "failure_boundary": "after_runtime_bundle_verification_before_first_pip_download",
            "root_cause": "version_head_pipeline_sigpipe_under_set_eo_pipefail",
            "repair": "record_full_gcc_and_ldd_version_output_without_head_pipeline",
        ...
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2r1"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R1_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R1_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2r1 bundle."
    )
