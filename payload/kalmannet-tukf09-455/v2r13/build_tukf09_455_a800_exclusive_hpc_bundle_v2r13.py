"""Build, inspect, and safely extract the TUKF09 455-basin A800-exclusive HPC v2r13 bundle.
...
DEFAULT_BUNDLE_OUTPUT = ROOT / "artifacts" / "tukf09_455_a800_exclusive_hpc_bundle_v2r13"
ARCHIVE_NAME = "tukf09_455_basin_zero_validation_target_variance_revision_v1_hpc_execution_a800_exclusive_v2r13_formal_training.tar.gz"
INTERNAL_MANIFEST_NAME = "bundle_manifest.json"
INTERNAL_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_bundle_manifest_v2r13"
OUTER_SCHEMA = "tukf09_455_a800_exclusive_training_hpc_archive_manifest_v2r13"
...
CONFIG_RELATIVES = (
    ...
    "configs/tukf09_455_basin_zero_validation_target_variance_hpc_execution_a800_exclusive_v2r13.json",
    "configs/tukf09_455_basin_zero_validation_target_variance_revision_v1.json",
)
HPC_WRAPPER_RELATIVES = (
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r13/allocation_probe.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r13/download_runtime_inputs_login.sh",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r13/probe_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r13/psutil-source.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r13/runtime-binary.lock",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r13/stage_and_train.py",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r13/submit_training_gpu.slurm",
    "hpc/tukf09_455_basin_revision_a800_exclusive_v2r13/verify_result.py",
)
BUILDER_RELATIVE = "scripts/build_tukf09_455_a800_exclusive_hpc_bundle_v2r13.py"
...
def _validate_config_anchors(
    ...
    *,
    ...
    if (
        hpc.get("schema_version") != "tukf09_455_basin_hpc_execution_a800_exclusive_v2r13"
        ...
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r13_20260909/status/PREPARATION_FAILED.json"
        or hpc_remote_layout.get("runtime_pending_glob")
        != "/data1/home/sunyiq/kalmannet_tukf09_455_basin_zero_validation_target_variance_revision_v1_a800_exclusive_v2r13_20260909/runtime_v2r13.pending.*"
        ...
        != "preserve_the_partial_reserved_destination_and_freeze_the_v2r13_remote_root_no_same_root_retry"
        or hpc_data_staging.get("existing_tree_policy")
        != "exact_verify_only_no_overwrite"
        or offline_inputs.get("schema_version")
        != "tukf09_455_hpc_offline_runtime_inputs_a800_exclusive_v2r13"
        ...
        != "tukf09_455_hpc_private_runtime_manifest_a800_exclusive_v2r13"
...
def verify_extracted_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R13_HPC_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
...
def verify_runtime_bundle(destination: Path) -> dict[str, Any]:
    ...
    return {
        "status": "TUKF09_455_A800_EXCLUSIVE_V2R13_HPC_RUNTIME_BUNDLE_VERIFIED",
        "experiment_id": EXPERIMENT_ID,
        "member_count": len(hashes),
        "admitted_executable_count": EXPECTED_ADMITTED_EXECUTABLE_COUNT,
        "admitted_test_count": EXPECTED_ADMITTED_TEST_COUNT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build, verify, or safely extract the deterministic TUKF09 455-basin A800-exclusive HPC v2r13 bundle."
    )
