#!/usr/bin/env bash
# Read-only terminal collection. No certificate flag, scheduler writes, or tensor imports.
set -euo pipefail
...
expected_payload = '/data1/home/sunyiq/hpc_mailbox/payload/kalmannet-wrr-hp-extension/model-selection20260908-audit-terminal-A-20260909-v1'
...
if hashlib.sha256(manifest_bytes).hexdigest() != 'b38ae38b9f00a4c86eabe1510becbef18548e47dd267edffbc1d74bf5076d829':
