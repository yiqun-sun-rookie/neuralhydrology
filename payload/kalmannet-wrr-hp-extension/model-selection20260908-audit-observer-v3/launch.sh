...
expected_payload = '/data1/home/sunyiq/hpc_mailbox/payload/kalmannet-wrr-hp-extension/model-selection20260908-audit-observer-v3'
...
if hashlib.sha256(manifest_bytes).hexdigest() != '5090878f8827eff01bada4f82c152675882778a00998ec9304d97f76a83fc2f4':
