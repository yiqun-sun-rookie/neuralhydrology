...
def forecast_from_posterior(
    ...
    Candidate probabilities stay at the final assimilation posterior. The copied
    bank uses an identity model transition matrix, which also removes cross-candidate
    state mixing during the forecast. The assimilation state in ``bank`` is untouched.
    """
