...
def strict_prerequisite_hashes_v09(paths: StrictStagePathsV09) -> dict[str, str]:
    ...
    if legacy.get("formal_evaluation_observation_reads") != 0:
        raise ValueError("legacy bridge audit formal-observation boundary drift")
...
def run_formal_strict_stage_v09() -> dict:
    ...
    prerequisites = strict_prerequisite_hashes_v09(paths)
