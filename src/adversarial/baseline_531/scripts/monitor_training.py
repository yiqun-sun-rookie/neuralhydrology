...
使用方式：
    # 监控最新训练
    python src/full_531_basins/scripts/monitor_training.py
    
    # 监控指定训练运行
    python src/full_531_basins/scripts/monitor_training.py --run-dir runs/full_training_2025_1024_1631
    
    # 启用详细监控
    python src/full_531_basins/scripts/monitor_training.py --verbose
    
    # 生成训练报告
    python src/full_531_basins/scripts/monitor_training.py --report
