...
Usage:
    python src/namou_kuwei/scripts/validate_config.py path/to/config.yml
    python src/namou_kuwei/scripts/validate_config.py --dir src/namou_kuwei/configs/
    python src/namou_kuwei/scripts/validate_config.py --dir src/ --verbose
"""
import argparse
import yaml
