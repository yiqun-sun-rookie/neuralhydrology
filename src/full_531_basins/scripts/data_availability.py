...
Usage (examples):
  python data_availability.py --data-dir data/CAMELS_US \
      --basin-file src/full_531_basins/data/splits/full_674_basins_train_basins.txt \
      --start 1999-10-01 --end 2008-09-30 --out report_train.csv

  # Merge train/val/test
  python data_availability.py --data-dir data/CAMELS_US \
      --basin-file src/full_531_basins/data/splits/full_674_basins_train_basins.txt \
      --basin-file src/full_531_basins/data/splits/full_674_basins_val_basins.txt \
      --basin-file src/full_531_basins/data/splits/full_674_basins_test_basins.txt \
