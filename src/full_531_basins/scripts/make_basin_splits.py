...
def main():
    ...
    parser.add_argument("--all", dest="all_path", type=str,
                        default="src/full_531_basins/data/splits/all_basins.txt",
                        help="Path to all basins list")
    parser.add_argument("--out-train", dest="out_train", type=str,
                        default="src/full_531_basins/data/splits/full_674_basins_train_basins.txt")
    parser.add_argument("--out-val", dest="out_val", type=str,
                        default="src/full_531_basins/data/splits/full_674_basins_val_basins.txt")
    parser.add_argument("--out-test", dest="out_test", type=str,
                        default="src/full_531_basins/data/splits/full_674_basins_test_basins.txt")
