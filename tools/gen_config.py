...
Usage Examples:
    ...
    python tools/gen_config.py --site namou_kuwei --type ar_static --lead 24
...
def load_site_config(site_name: str) -> dict:
    ...
    candidates = [
        repo_root / "src" / "templates" / f"site_{site_name}.yml",
        repo_root / "src" / site_name / "configs" / f"site_{site_name}.yml",
...
def main():
    ...
    if args.output:
        ...
        output_dir = Path(__file__).parent.parent / "src" / args.site / "configs" / "generated"
