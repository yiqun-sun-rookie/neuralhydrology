#!/bin/bash
# nature1st-attr-swap seq=78 -- armG watchdog, unattended routine re-check. READ-ONLY, no sbatch, no resubmit.
# Job 207826 = q_armG_china_supplyable. Previous check (seq=77, 23:29 CST): COMPLETED 09:55:16 on ngu007,
