#!/bin/bash
# nature1st-attr-swap seq=71 -- armG watchdog. READ-ONLY, no sbatch, no resubmit.
...
# Previous check (seq=70, 02:29): RUNNING 8:41, epoch 18, guard confirmed 17 attributes, best epoch 16 median 0.6299.
set -o pipefail
