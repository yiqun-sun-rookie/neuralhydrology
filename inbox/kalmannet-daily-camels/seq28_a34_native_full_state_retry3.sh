...
PAYLOAD_DIRECTORY="${MAILBOX_ROOT}/payload/kalmannet-daily-camels/native-full-state-a20-contract-a34-infra-retry3-v28"
...
ARCHIVE_SHA256="50687dbaf6a6fc23126aed55a02719a6b3b8712a623a6b58839e5de48106986c"
ARCHIVE_SIZE=245276
...
STAGING_DIRECTORY="/data1/home/sunyiq/kalmannet_daily_camels_full_state_a34_retry3_staging_20260826"
...
NAMESPACE_OWNED=0
SAFE_TO_PACKAGE=0
FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_STARTED"
...
SAFE_TO_PACKAGE=1
trap on_exit EXIT
trap 'FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_INTERRUPTED"; exit 143' INT TERM
...
FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_NAMESPACE_OWNED"
...
PY
FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_OFFLINE_BUNDLE_VERIFIED"

SAFE_TO_PACKAGE=0
if ! TRAINING_JOB_ID="$(sbatch --parsable hpc/daily_camels_native_kalmannet_full_state_masked_nse/submit_smoke_gpu.slurm)"; then
  SAFE_TO_PACKAGE=1
  FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_SUBMISSION_REJECTED_HARD_STOP"
  exit 56
fi
[[ "$TRAINING_JOB_ID" =~ ^[0-9]+$ ]] || { FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_SUBMISSION_IDENTITY_HARD_STOP"; exit 57; }
printf '%s\n' "$TRAINING_JOB_ID" > "${STATUS_DIRECTORY}/training_job_id.txt"
FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_SUBMITTED"
...
case "$TERMINAL_STATE" in
  COMPLETED|FAILED|CANCELLED|TIMEOUT|OUT_OF_MEMORY|NODE_FAIL|PREEMPTED|BOOT_FAIL|DEADLINE)
    ...
    ;;
  *)
    FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_MONITOR_TIMEOUT_JOB_LEFT_RUNNING_NO_EVIDENCE"
    exit 58
    ;;
esac
sacct -j "$TRAINING_JOB_ID" --units=K --parsable2 --format=JobIDRaw,JobName,Partition,AllocCPUS,State,ExitCode,Elapsed,ReqMem,AllocTRES,MaxRSS,MaxVMSize > "${STATUS_DIRECTORY}/seq28_A34_infra_retry3_sacct_resources.txt"
...
PY
  then
    FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_VERIFIED_RECOVERABLE_STOP"
    exit 75
  fi
  FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_TRAINING_${TERMINAL_STATE:-UNKNOWN}_HARD_STOP"
  exit 59
fi
FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_TRAINING_COMPLETED"
...
FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_SCHEDULED_EVIDENCE_VERIFIED"
...
if [[ "$WORKFLOW_STATUS" = "VERIFIED_SCIENTIFIC_PASS" ]]; then
  FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_VERIFIED_SCIENTIFIC_PASS"
  echo "DAILY_CAMELS_NATIVE_KALMANNET_A34_INFRA_RETRY3_VERIFIED_SCIENTIFIC_PASS job=${TRAINING_JOB_ID}"
else
  FINAL_STATUS="SEQ28_A34_INFRA_RETRY3_VERIFIED_SCIENTIFIC_HARD_STOP"
  echo "DAILY_CAMELS_NATIVE_KALMANNET_A34_INFRA_RETRY3_VERIFIED_SCIENTIFIC_HARD_STOP job=${TRAINING_JOB_ID}"
fi
