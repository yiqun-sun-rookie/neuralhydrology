...
ARCHIVE="${CHANNEL_OUTBOX}/DAILY_CAMELS_KNET_A39_JOB217038_TERMINAL_EVIDENCE_SEQ101.tar.gz"
COLLECTOR_SOURCE="${CHANNEL_INBOX}/seq101_a39_job217038_terminal_collect.sh"
CMD_SOURCE="${CHANNEL_INBOX}/cmd.sh"
DISPATCH_SNAPSHOT="${CHANNEL_INBOX}/seq101_a39_dispatch_cmd.sh"
...
ARCHIVE_TEMP=""
ARCHIVE_PUBLISHED=0
STAGING_ROOT="$(mktemp -d "/data1/home/sunyiq/a39-seq101-terminal.XXXXXXXX")"
cleanup() {
  if [[ -n "${ARCHIVE_TEMP}" ]]; then
    case "${ARCHIVE_TEMP}" in
      "${CHANNEL_OUTBOX}/DAILY_CAMELS_KNET_A39_JOB217038_TERMINAL_EVIDENCE_SEQ101.tar.gz.tmp."*)
  ...
  case "${STAGING_ROOT}" in
    /data1/home/sunyiq/a39-seq101-terminal.*) rm -rf -- "${STAGING_ROOT}" ;;
    *) echo "refusing unsafe staging cleanup: ${STAGING_ROOT}" >&2 ;;
  esac
}
trap cleanup EXIT
EVIDENCE_ROOT="${STAGING_ROOT}/DAILY_CAMELS_KNET_A39_JOB217038_TERMINAL_EVIDENCE_SEQ101"
...
print(
    "SEQ101_A39_GPU_RESOURCE_SUMMARY "
...
print(
    "SEQ101_A39_HOST_MEMORY_RESOURCE_SUMMARY "
...
print(
    "SEQ101_A39_INDEPENDENT_TERMINAL_VALIDATION "
