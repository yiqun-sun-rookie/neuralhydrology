...
RECEIPT_B64 = ""
NONCE = "c16b0a8f0be48dfdc3e1975f4d4ace3d"
EXPECTED_DEPLOYMENT_SHA = "987bedd9eecc7d7586aaa5e39b53f666f5393322de59fda9bbcbce3579f91f2a"
EXPECTED_BINDING_B64 = "eyJpbm9kZSI6NjE3NDM5MzYwNywibW9kZSI6NDQ4LCJ1aWQiOjIyNzJ9"
...
def main():
    ...
    argv = ["sbatch", "--parsable", "--partition=hgpu2p", "--nodes=1",
            ...
            "--no-requeue", "--time=01:00:00", "--output=/dev/null",
            "--error=/dev/null", "--job-name=zhenjiang-update-temporal-eval",
