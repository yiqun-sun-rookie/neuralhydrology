...
[ -d "${ROOT}" ] || fatal "deployment root is absent"
...
[ "$(sha256sum "${SCRIPT}" | awk '{print $1}')" = \
  "bed0261687b64156264abd288672967b4d6af0fe40a3038e54edd84e5b8e2fdf" ] || \
  fatal "smoke script identity changed"
...
print("PRE2024_SUBMISSION_GATE=PASS")
PY
...
echo "SMOKE_SUBMISSION=ACCEPTED"
