...
sacct -X -j 227626 -n -P --format=JobIDRaw,JobName,State,ExitCode,Elapsed,NodeList || true
printf '\nELEVENTH_COMPLETED_CELL_INDEPENDENT_AUDIT\n'
...
out=root/'formal_attempt_003/runs/objective-current-0-highflow-1-seed-44'
...
cell=protocol['cells'][11]
assert cell['exp_id']==out.name and cell['lambda_upd']==0 and cell['alpha_hf']==1 and cell['seed']==44
...
assert start['cell']==cell and start['job_id']=='227626' and start['array_identity']=='227626_11'
...
assert best['epoch']==complete['best_epoch']==5 and best['common_validation_mse']==complete['best_validation_mse']==1.0417999758667021e-05
