#!/bin/bash
# kalmannet-daily-perbasin sequence=151: READ-ONLY observation (phase_a). No sbatch, no scancel, no writes.
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=151 purpose=observe-phase_a"
