#!/bin/bash
# kalmannet-daily-perbasin sequence=135: READ-ONLY observation of training job 225865 (basin 14185900, launch seq 134).
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=135 purpose=read-only-observe-train-14185900-job225865"
...
RUN=$ROOT/runs/DAILY_CAMELS_KNET_PER_BASIN_21_DEVELOPMENT_V2_20260908_BASIN_14185900_A40_TRAIN1_SEQ134
JOB=225865
...
case "$STATE" in
  COMPLETED|FAILED|TIMEOUT|NODE_FAIL|OUT_OF_MEMORY|CANCELLED*)
    ...
    emit_file "$REQ/submission_seq134.receipt.json"
