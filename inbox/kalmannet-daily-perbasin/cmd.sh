#!/bin/bash
# kalmannet-daily-perbasin sequence=108: READ-ONLY observation of training job 225559 (basin 02178400, launch seq 107).
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=108 purpose=read-only-observe-train-02178400-job225559"
...
RUN=$ROOT/runs/DAILY_CAMELS_KNET_PER_BASIN_21_DEVELOPMENT_V2_20260908_BASIN_02178400_A40_TRAIN1_SEQ107
JOB=225559
...
case "$STATE" in
  COMPLETED|FAILED|TIMEOUT|NODE_FAIL|OUT_OF_MEMORY|CANCELLED*)
    ...
    emit_file "$REQ/submission_seq107.receipt.json"
