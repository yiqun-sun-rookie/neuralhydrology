#!/bin/bash
# kalmannet-daily-perbasin sequence=131: READ-ONLY observation of training job 225826 (basin 01435000, launch seq 130).
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=131 purpose=read-only-observe-train-01435000-job225826"
...
RUN=$ROOT/runs/DAILY_CAMELS_KNET_PER_BASIN_21_DEVELOPMENT_V2_20260908_BASIN_01435000_A40_TRAIN1_SEQ130
JOB=225826
...
case "$STATE" in
  COMPLETED|FAILED|TIMEOUT|NODE_FAIL|OUT_OF_MEMORY|CANCELLED*)
    ...
    emit_file "$REQ/submission_seq130.receipt.json"
