#!/bin/bash
# kalmannet-daily-perbasin sequence=104: READ-ONLY observation of training job 225484 (basin 12447390, launch seq 103).
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=104 purpose=read-only-observe-train-12447390-job225484"
...
RUN=$ROOT/runs/DAILY_CAMELS_KNET_PER_BASIN_21_DEVELOPMENT_V2_20260908_BASIN_12447390_A40_TRAIN1_SEQ103
JOB=225484
...
case "$STATE" in
  COMPLETED|FAILED|TIMEOUT|NODE_FAIL|OUT_OF_MEMORY|CANCELLED*)
    ...
    emit_file "$REQ/submission_seq103.receipt.json"
