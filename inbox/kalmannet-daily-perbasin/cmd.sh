#!/bin/bash
# kalmannet-daily-perbasin sequence=180: READ-ONLY observation (analysis). No sbatch, no scancel, no writes.
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=180 purpose=observe-analysis"
...
echo "=== ANALYSIS unseal_a.marker.json ==="; emit_json $ROOT/unseal_a.marker.json
echo "=== ANALYSIS analysis/unseal_a_summary/summary.json ==="; emit_json $ROOT/analysis/unseal_a_summary/summary.json
echo "=== ANALYSIS analysis/unseal_a_summary/summary.md ==="; emit_json $ROOT/analysis/unseal_a_summary/summary.md
echo "=== ANALYSIS deploy_manifest_addendum_unseal_a_seq179.sha256 ==="; emit_json $ROOT/deploy_manifest_addendum_unseal_a_seq179.sha256
