#!/bin/bash
# kalmannet-daily-perbasin sequence=110: READ-ONLY observation of training job 225566 (basin 09513780, launch seq 109).
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=110 purpose=read-only-observe-train-09513780-job225566"
...
RUN=$ROOT/runs/DAILY_CAMELS_KNET_PER_BASIN_21_DEVELOPMENT_V2_20260908_BASIN_09513780_A40_TRAIN1_SEQ109
JOB=225566
...
case "$STATE" in
  COMPLETED|FAILED|TIMEOUT|NODE_FAIL|OUT_OF_MEMORY|CANCELLED*)
    ...
    emit_file "$REQ/submission_seq109.receipt.json"
