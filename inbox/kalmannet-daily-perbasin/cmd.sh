...
echo '=== READ-ONLY 08070200 PROGRESS QUERY ==='
date --iso-8601=seconds
hostname
echo 'channel=kalmannet-daily-perbasin sequence=19 purpose=read-only-second-pilot-runtime-gate-and-training-progress'
