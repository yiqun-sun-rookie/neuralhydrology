#!/bin/bash
# kalmannet-daily-perbasin sequence=123: READ-ONLY observation of training job 225740 (basin 08086290, launch seq 122).
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=123 purpose=read-only-observe-train-08086290-job225740"
...
RUN=$ROOT/runs/DAILY_CAMELS_KNET_PER_BASIN_21_DEVELOPMENT_V2_20260908_BASIN_08086290_A40_TRAIN1_SEQ122
JOB=225740
...
case "$STATE" in
  COMPLETED|FAILED|TIMEOUT|NODE_FAIL|OUT_OF_MEMORY|CANCELLED*)
    ...
    emit_file "$REQ/submission_seq122.receipt.json"
