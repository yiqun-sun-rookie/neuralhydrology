#!/bin/bash
# kalmannet-daily-perbasin sequence=133: READ-ONLY observation of training job 225855 (basin 02092500, launch seq 132).
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=133 purpose=read-only-observe-train-02092500-job225855"
...
RUN=$ROOT/runs/DAILY_CAMELS_KNET_PER_BASIN_21_DEVELOPMENT_V2_20260908_BASIN_02092500_A40_TRAIN1_SEQ132
JOB=225855
...
case "$STATE" in
  COMPLETED|FAILED|TIMEOUT|NODE_FAIL|OUT_OF_MEMORY|CANCELLED*)
    ...
    emit_file "$REQ/submission_seq132.receipt.json"
