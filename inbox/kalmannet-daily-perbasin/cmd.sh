#!/bin/bash
# kalmannet-daily-perbasin sequence=121: READ-ONLY observation of training job 225714 (basin 08109700, launch seq 120).
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=121 purpose=read-only-observe-train-08109700-job225714"
...
RUN=$ROOT/runs/DAILY_CAMELS_KNET_PER_BASIN_21_DEVELOPMENT_V2_20260908_BASIN_08109700_A40_TRAIN1_SEQ120
JOB=225714
...
case "$STATE" in
  COMPLETED|FAILED|TIMEOUT|NODE_FAIL|OUT_OF_MEMORY|CANCELLED*)
    ...
    emit_file "$REQ/submission_seq120.receipt.json"
