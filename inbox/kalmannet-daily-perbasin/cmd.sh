#!/bin/bash
# kalmannet-daily-perbasin sequence=127: READ-ONLY observation of training job 225767 (basin 05503800, launch seq 126).
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=127 purpose=read-only-observe-train-05503800-job225767"
...
RUN=$ROOT/runs/DAILY_CAMELS_KNET_PER_BASIN_21_DEVELOPMENT_V2_20260908_BASIN_05503800_A40_TRAIN1_SEQ126
JOB=225767
...
case "$STATE" in
  COMPLETED|FAILED|TIMEOUT|NODE_FAIL|OUT_OF_MEMORY|CANCELLED*)
    ...
    emit_file "$REQ/submission_seq126.receipt.json"
