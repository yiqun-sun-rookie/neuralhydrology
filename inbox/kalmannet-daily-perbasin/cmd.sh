#!/bin/bash
# kalmannet-daily-perbasin sequence=173: READ-ONLY observation (analysis). No sbatch, no scancel, no writes.
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=173 purpose=observe-analysis"
...
echo "=== ANALYSIS analysis/e8_node_seq172/e8.json ==="; emit_json $ROOT/analysis/e8_node_seq172/e8.json
