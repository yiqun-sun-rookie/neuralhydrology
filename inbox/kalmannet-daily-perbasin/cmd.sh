#!/bin/bash
# kalmannet-daily-perbasin sequence=149: READ-ONLY observation (phase_a). No sbatch, no scancel, no writes.
set -o pipefail
echo "channel=kalmannet-daily-perbasin sequence=149 purpose=observe-phase_a"
