#!/bin/bash
# Read-only status capture for the package-native A800 allocation probe.
set -o pipefail
...
EXPECTED_PROBE_SCRIPT_SHA=0dbee5218b46fb31336e779c6ceb86d1904e3549f22b9bfe5b60ba8bbb02cbb7
...
echo "TUKF09_455_A800_EXCLUSIVE_V2_ALLOCATION_PROBE_READONLY_STATUS_CAPTURED"
