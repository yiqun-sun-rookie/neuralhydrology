#!/bin/bash
# TUKF09-455 v2r8: submit exactly one neural training job. Nine models, three seeds
...
JOB="$PROJECT/hpc/tukf09_455_basin_revision_a800_exclusive_v2r8/submit_training_gpu.slurm"
...
echo TUKF09_455_V2R8_NEURAL_TRAINING_SUBMITTED_ONCE_FORMAL_EVALUATION_HOLD
