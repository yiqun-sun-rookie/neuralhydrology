#!/bin/bash
# TUKF09-455 v2r8: create the cluster technical admission only. No training job here.
set -o pipefail
...
TOOL="$PROJECT/hpc/tukf09_455_basin_revision_a800_exclusive_v2r8/stage_and_train.py"
PYSITE="$ROOT/runtime_v2r8/pysite"
PROBE="$ROOT/status/preparation_probe.json"
PRIVATE="$ROOT/runtime_v2r8/evidence/private_runtime_manifest.json"
...
echo TUKF09_455_V2R8_TECHNICAL_ADMISSION_CREATED_TRAINING_NOT_SUBMITTED
