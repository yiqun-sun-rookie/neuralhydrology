#!/bin/bash
# Submit exactly one package-native v2r1 allocation probe before mutable preparation.
set -o pipefail
umask 077
...
PROBE_SCRIPT_SHA=5dc332b67998b6a2fa3b5a37f3db40694ff21cea832ff61750a527f136a4597b
...
echo "TUKF09_455_A800_EXCLUSIVE_V2R1_ALLOCATION_PROBE_SUBMITTED_ONCE"
