...
request={'file': {'bytes': 140755, 'path': '/data1/home/sunyiq/zhenjiang_shared_base_no_training_time_cap_20260917_001/evaluate/information/batch_2.json', 'sha256': 'dd4200be8220b907f7394c2edeef6f4efe32b085acd99a01dea805e8a3c1459a'}, 'index': 0, 'length': 140755, 'offset': 0}
import base64
gate=Root(REMOTE_ROOT,binding)
try:
    authenticate(gate,release_sha,binding)
    raw=gate.read('evaluate/information/batch_2.json',maximum=8000000,expected={'bytes': 140755, 'sha256': 'dd4200be8220b907f7394c2edeef6f4efe32b085acd99a01dea805e8a3c1459a'})
...
# collection command seq_137_chunk
