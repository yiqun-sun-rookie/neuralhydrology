...
request={'file': {'bytes': 140755, 'path': '/data1/home/sunyiq/zhenjiang_shared_base_no_training_time_cap_20260917_001/evaluate/information/batch_1.json', 'sha256': '50e385dadce328a932b97e97d897e00ba76ae4edb391a55d646b97bfe42e76d1'}, 'index': 0, 'length': 140755, 'offset': 0}
import base64
gate=Root(REMOTE_ROOT,binding)
try:
    authenticate(gate,release_sha,binding)
    raw=gate.read('evaluate/information/batch_1.json',maximum=8000000,expected={'bytes': 140755, 'sha256': '50e385dadce328a932b97e97d897e00ba76ae4edb391a55d646b97bfe42e76d1'})
...
# collection command seq_136_chunk
