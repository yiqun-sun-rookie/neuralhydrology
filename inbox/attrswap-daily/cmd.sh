...
# then one gate per product + its 3 arms, all on partition __PART__ (D6). Products listed in PRODUCTS below are those
...
sed -i "s/__PART__/$PART/" hpc_deploy/pswap2_gate_ref.slurm hpc_deploy/pswap2_gate_product.slurm hpc_deploy/pswap2_train.slurm
