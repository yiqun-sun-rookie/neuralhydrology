...
echo "=== ANY N22-warmpair* SINCE 09-03 ==="
sacct -X -n -P -S 2026-09-03 --format=JobID,JobName,State,ExitCode,Elapsed,End 2>/dev/null | grep -E 'warmpair|warmana' || echo '  none'
echo "=== WARMPAIR DIRS ==="
