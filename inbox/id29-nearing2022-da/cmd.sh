...
echo "=== ANY N22-warm* since 09-03 ==="
sacct -X -n -P -S 2026-09-03 --format=JobID,JobName,State,ExitCode,End 2>/dev/null | grep -E 'N22-warm' || echo '  none'
