#!/bin/bash
# ID29 seq=79: report Slurm health and full-role artifact progress after v12 deployment.
set -eo pipefail

ROOT=/data1/home/sunyiq/nearing2022_da
JOBS=202214,202215,202216,202222,202226,202227,202228,202229,202230,202238,202289,202290
...
sacct -n -P -j 202242,202280,202281 --format=JobID,JobName,State,ExitCode | sed '/^[[:space:]]*$/d'

echo "=== FINAL DEPENDENCIES ==="
for job in 202229 202230 202289 202290; do
