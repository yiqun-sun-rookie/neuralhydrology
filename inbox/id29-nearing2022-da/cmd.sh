#!/bin/bash
# ID29 seq=224: verify and recover the isolated >=17-coordinate numerical audit when terminal.
set -eo pipefail

ROOT=/data1/home/sunyiq/nearing2022_da
JOB_ID=202725
FINAL="$ROOT/results/29_nearing2022_da_ar/formal_closure/diagnostics/partial_numerical_audit_seq223_v1"
PREVIOUS="$ROOT/results/29_nearing2022_da_ar/formal_closure/diagnostics/partial_numerical_audit_seq205_v1"
STDOUT="$ROOT/closure_20260810/logs/N22-part-audit4_${JOB_ID}.out"
STDERR="$ROOT/closure_20260810/logs/N22-part-audit4_${JOB_ID}.err"
...
if audit["complete_coordinates"] < 17:
    raise ValueError("Terminal audit contains fewer than 17 complete coordinates")
...
if not set(old_coordinates) < set(new_coordinates):
    raise ValueError("The new audit does not strictly extend the 16-coordinate predecessor")
...
expected = "N22-EVAL-TS-DA-L04-TE025-S0"
...
summary = {
    "schema": "nearing2022-partial-numerical-audit-seq223-terminal-verification-v1",
    "job_id": "202725",
