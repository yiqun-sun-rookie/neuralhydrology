#!/bin/bash
# ID29 seq=228: verify and recover the isolated >=18-coordinate numerical audit when terminal.
set -eo pipefail
...
summary = {
    "schema": "nearing2022-partial-numerical-audit-seq227-terminal-verification-v1",
    "job_id": "202727",
