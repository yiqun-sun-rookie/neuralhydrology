...
REPLACEMENT_VERIFIER_SHA256 = "0b971f3b4d98d70184b0ba4c268e61d5b7173776719c662b52eb4cb3893e7969"
...
REPLACEMENT_VERIFIER_RELATIVE = (
    FORMAL_RELATIVE / "warmup_pair_v2_20260904/verify_warmup_target_replacement_chain_v2.py"
)
...
def _validate_joint_gate(
    ...
    _require_equal(
        artifact_1,
        "schema",
        "nearing2022-warmup-target-replacement-independent-verification-v2",
        "artifact",
    )
